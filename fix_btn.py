...
# Find the broken Btn section and fix it
# The issue is two Btn functions merged together
...
print(f"First Btn at: {first}")
print(f"Second Btn at: {second}")

if second>0:
    # Remove everything between first and second occurrences
  ...
  return (
    ...
    c=c[:first]+new_btn+c[end_of_second:]
    print("Fixed duplicate Btn!")
else:
