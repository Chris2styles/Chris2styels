  ...
  return (
    <div style={{minHeight:'100vh',background:'#F5F3EE',display:'flex',alignItems:'center',justifyContent:'center',fontFamily:'Helvetica Neue,sans-serif'}}>
      <div style={{textAlign:'center',padding:40}}>
        ...
        <p style={{color:'#666',fontSize:16,lineHeight:1.8,maxWidth:400,margin:'0 auto 12px'}}>Your membership is now active. Christine will be in touch shortly to book your first appointment.</p>
        <p style={{color:'#999',fontSize:13}}>Taking you back to the app in 5 seconds...</p>
      </div>
    </div>
  )
}