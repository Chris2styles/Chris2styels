const fs = require('fs');
let c = fs.readFileSync('app/HHCApp.jsx', 'utf8');
const start = c.indexOf('const ADDONS=[
...
c = c.slice(0, start) + newAddons + c.slice(end);
fs.writeFileSync('app/HHCApp.jsx', c);
console.log('Done!');